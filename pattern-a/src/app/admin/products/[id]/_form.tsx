...
export default function AdminProductEditForm({ isNew }: { isNew: boolean }) {
    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="bg-[#1A1A1A] border border-[#2A2A2A] rounded p-6 space-y-5">
        <div>
          ...
          <input type="text" defaultValue={isNew ? "" : "Silver Ring No.01"}
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <div className="relative">
              ...
              <input type="number" defaultValue={isNew ? "" : "8800"}
        ...
        <div>
          ...
          <textarea rows={4} defaultValue={isNew ? "" : "職人が一つひとつ丁寧に仕上げたシルバーリングです。シンプルなデザインで日常使いにぴったりです。"}
        ...
        <div className="flex gap-3 pt-2">
          <button className="bg-[#B8960C] text-black px-6 py-2.5 font-medium hover:bg-[#C9A84C] transition-colors">保存する</button>
          <Link href="/admin/products" className="border border-[#2A2A2A] text-[#C0C0C0] px-6 py-2.5 hover:border-[#C0C0C0] transition-colors">キャンセル</Link>
        </div>
      </div>
    </div>
  );
